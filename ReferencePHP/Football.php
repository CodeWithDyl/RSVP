...
<head>
	...
	<style>
		html {
			background-image: url(https://president-events.louisville.edu/oop/images/football/Blackouthelmet-min.jpg);
		}

		@media only screen and (max-width:767px) {
			body {
				background-image: url(https://president-events.louisville.edu/oop/images/football/blackouthelmet-mobile-min.jpg);
			}
		}
	</style>
</head>
				...
				<div id="bodyDiv" class="headerBodyFooter">
					<form class="ghost-form" action="<?= $formAction ?>" method="post">
						...
						<div id="formDiv" class="infoDivs">
							<h5>University of Louisville<br>
								...
								if ($InviteOptions == 'Tickets And Party' || $InviteOptions == 'Party Only') {
									...
									if ($Pre_game != '') {
										...
										echo '2 hours prior to Kick-off';
									}
									echo '<br>';
								} else {
									echo '';
							...
							<div class="selectContainer">
								...
								?>
									<div class="form-group row align-items-center justify-content-center">
										<label class="col-form-label">Complimentary Tickets:</label>
								...
								?>
									<div class="form-group row align-items-center justify-content-center">
										<label class="col-form-label">Tailgate Tickets:</label>
										<section class="col-auto">
							...
							<br>
							<input class="ghost-input ghost-input-underlined" name="Guest" placeholder="Guest Name" value="" type="text" /><br>
							<br style="clear:both">
						</div>
						<br style="clear:both">
